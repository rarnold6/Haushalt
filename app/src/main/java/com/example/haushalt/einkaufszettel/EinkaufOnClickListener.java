...
/*
    Klasse, die dafuer zustaendig ist, den Einkauf abzuschliessen und automatisch einen Vorschlag zu
    bringen, wo schon zuvor im Gefrierschrank gelagerte Elemente wieder eingeraeumt werden koennten
 */
class EinkaufOnClickListener implements View.OnClickListener {

    private Context context;
    private View view;
    private LinkedList<GefrierschrankElement> boughtItemsIntoHome;
    private PopupWindow popupWindow;
    private FragmentActivity activity;
    private HashMap<Integer, Integer> idsEinkaufszettel = new HashMap<>();
    private GefrierschrankElement elementOnFocus;
    private EditText editTextOnFocus;
    private LinkedList<EinkaufszettelElement> boughtNotIntoHome;
    private ArrayAdapter<EinkaufszettelElement> einfuegeSpinnerAdapter;
    private Gefrierschrank gefrierschrank;

    private BaseAdapter einkaufBaseAdapter;

    EinkaufOnClickListener(Context context, View view, FragmentActivity activity, BaseAdapter einkaufBaseAdapter) {
        this.context = context;
        this.view = view;
        this.activity = activity;
        this.einkaufBaseAdapter = einkaufBaseAdapter;

    }

    @Override
    public void onClick(View view) {
        this.boughtItemsIntoHome = getBoughtItems();
        openPopUpWindow();
    }

    //es werden die gekauften und schonmal im Gefrierschrank gelagerten Elemente in einer Menge zurueckgegeben
    private LinkedList<GefrierschrankElement> getBoughtItems() {
    ...
    private void openPopUpWindow() {
        ...
        inflateLinearLayout(linearLayout);
        ...
        einfuegeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if(i != 0) {
                    ...
                    inflateLinearLayout(gefrierschrankElement, linearLayout);
    ...
    private void inflateLinearLayout(final LinearLayout linearLayout) {
    ...
    private void inflateLinearLayout(final GefrierschrankElement gefrierschrankElement, final LinearLayout linearLayout){
            ...
            Spinner fach = (Spinner) view1.findViewById(R.id.fach_spinner);
    ...
    private void updateFreezer() {
        for (GefrierschrankElement gefrierschrankElement : this.boughtItemsIntoHome) {
